...
## Smallest K Option
The “Smallest-K” routines automatically search for the simplest model that remains statistically consistent with the observed data. Starting from the best-fitting K, the procedure iteratively tests decreasing values of K to identify the smallest value of K that still meets the user's goodness-of-fit criteria (i.e., p > α). A detailed description of this section can be found here: [**FAQ: Smallest K Model**](FAQ.html#smallest-k).
