...
Started](articles/GettingStarted.html) guide, which walks through the
main function and its various arguments. This can also be accessed from
an R session with:

    vignette("GettingStarted", package = "GenErlangFit")

Technical details regarding the fitting algorithms and assumptions can
be found in the [FAQ](articles/FAQ.html).
